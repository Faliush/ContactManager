...
public class CountryGetHandlerTests
{
    ...
    public async Task Handler_Should_ReturnEmptyResult_WhenCountriesIsNotExistInDatabase()
    {
        //arrange
    ...
    [Fact]
    [Trait("GetHandleTests", nameof(Country))]
    public async Task Handler_Should_ReturnSomeCountries_WhenDatabaseIsNotEmpty()
    {
        // arrange
        var request = new CountryGetAllRequest();
    ...
    [Fact]
    [Trait("GetHandleTests", nameof(Country))]
    public async Task Handler_Should_ThrowContactManagerNotFoundException_WhenCountryIdIsNotExistForUpdate()
    {
    ...
    [Fact]
    [Trait("GetHandleTests", nameof(Country))]
    public async Task Handler_Should_ReturnSuccessResult_WhenIdIsCorrectForUpdate()
    {
